...
- `docs/governance-run-input.example.json` is current
- `contract_version` is correct
- `docs/operations/governance-evidence-contract.md` is aligned
- `docs/operations/governance-evidence-schema-versioning.md` is aligned
