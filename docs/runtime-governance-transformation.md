...
The input document `docs/governance/source-documents/SDD_Architecture_Governance_Framework_20260630v2.md` is a strong normative architecture governance framework, but it is not yet optimized for runtime governance.
